...
const SecondGuide = ({ btn, onClose }: guideProps) => {
  ...
  return (
    <div className="fixed inset-0 flex justify-center bg-white z-50">
      <div className="desktop:pt-[10%] bg-white relative flex flex-col items-center pt-[15%]">
        <button
          onClick={handleClick}
          className=" text-[14px] mr-5 mt-5 text-white text-center fixed top-0 right-0 rounded-3xl px-4 h-8 bg-[#E87775]"
        >
          {btn}
        </button>
