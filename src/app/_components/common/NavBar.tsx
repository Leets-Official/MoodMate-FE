      ...
      {openModal && (
        <ModalPortal nodeName="mainPortal">
          <ModalOutside
            ...
            className="max-w-md scroll overflow-hidden bg-white w-[260px] h-[467px] px-10 rounded-[25px] shadow-sm py-10 z-50 pointer-events-auto"
          >
            <ModalContent
      ...
      {chatModal && (
        <ModalPortal nodeName="mainPortal">
          <ModalOutside
            ...
            className="max-w-md scroll overflow-hidden bg-white w-[260px] h-[467px] px-10 rounded-[25px] shadow-sm z-50 pointer-events-auto"
          >
            <ModalContentOne
