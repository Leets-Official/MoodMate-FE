...
const NavBar = ({ type, userId, roomId, roomActive, gender }: TextProps) => {
  ...
  return (
    <div className="translate-y-[43px] fixed bottom-0 left-1/2 -translate-x-1/2 desktop:w-[378px] w-full">
      <div
        className={`${
      ...
      {openModal && (
        <ModalPortal nodeName="mainPortal">
          <ModalOutside
            ...
            className="max-w-md scroll overflow-hidden bg-white w-[260px] h-[467px] px-10 rounded-[25px] shadow-sm py-10 z-50"
          >
            <ModalContent
