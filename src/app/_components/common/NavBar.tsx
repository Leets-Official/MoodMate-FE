...
const getTextStyle = (type: string) => {
  switch (type) {
    ...
    case 'AFTER':
      return (
        <div className="pt-11 h-[223px] rounded-[88px] translate-y-1/3 flex justify-between bg-[#FFFFFF]">
          <div className="ml-16">
            <Icons name={deactivation} />
          </div>
          <div className="bg-[#FC4F59] rounded-full w-[72px] h-[72px] -mt-16">
            <Icons name={whitechat} className="ml-6 mt-6" />
          </div>
          <div className="mr-16">
            <Icons name={bio} />
          </div>
